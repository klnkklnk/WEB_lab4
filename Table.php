...
<body>
    ...
    <input type="text" name="name" placeholder="Введите поле name">
    <input type="text" name="salary" placeholder="Введите поле salary">
    <input type="text" name="age" placeholder="Введите поле age">
    <input type="text" name="smth" placeholder="Введите поле smth">
